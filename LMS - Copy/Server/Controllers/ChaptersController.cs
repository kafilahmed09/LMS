...
namespace LMS.Server.Controllers
{
    ...
    public class ChaptersController : ControllerBase
    {
        ...
        {
            return await _context.Chapters.Include(a=>a.Subject.Grade).ToListAsync();
        }
        ...
        {
            var chapter = await _context.Chapters.Include(a=>a.Subject.Grade).Where(a=>a.ChapterId == id).FirstOrDefaultAsync();
